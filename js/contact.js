...
// document.querySelector('.header__option--login').innerHTML = ""
// document.querySelector('.header__option--login').innerHTML = `<i class="fa-solid fa-user"></i><i class="fa-solid fa-cart-shopping"></i>`
